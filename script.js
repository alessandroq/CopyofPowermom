$(document).ready(function() {
  ...
  function MedicationListLib() {
    lib_instance = "v3zyslbtdw";
    com.fc.JavaScriptDistLib.EventListeners.mapLib("MedicationListLib", "v3zyslbtdw");
    ...
    LibVars.medicationlistlib.cellHeight = null;
    ...
    function handleDoneButton() {
      return new Promise(function(resolve, reject) {
        com.fc.JavaScriptDistLib.EventListeners.invoke("handleDoneButton", "v3zyslbtdw", []);
      });
    }
    /**
     * Describe this function...
    ...
    function handleCancelButton() {
      return new Promise(function(resolve, reject) {
        com.fc.JavaScriptDistLib.EventListeners.invoke("handleCancelButton", "v3zyslbtdw", []);
      });
    }
    /**
      ...
      try {
        ...
        if(com.fc.JavaScriptDistLib.MathLibrary.mathCompare(LibVars.medicationlistlib.medicationList.length, "GT", 0)) {
          ...
          if(com.fc.JavaScriptDistLib.ListLibrary.listContains(LibVars.medicationlistlib.selectedMedicationList, LibVars.medicationlistlib.medicationList[number])) {
            ...
            com.fc.JavaScriptDistLib.Image.setProperty["Image"]("Checkbox", (com.fc.JavaScriptDistLib.ImageLibrary.createImageFromResource("./img/checked.png")));
          } else {
            // Block#: xdU$u`)nAwe+ThT]/~WL
            com.fc.JavaScriptDistLib.Image.setProperty["Image"]("Checkbox", (com.fc.JavaScriptDistLib.ImageLibrary.createImageFromResource("./img/empty.png")));
          }
        }
      } catch(e) {
        com.fc.JavaScriptDistLib.handleExceptionNative(e);
    ...
    function on_listview_cell_clicked_MedicationCell(MedicationCell, number) {
      try {
        ...
        if(com.fc.JavaScriptDistLib.ListLibrary.listContains(LibVars.medicationlistlib.selectedMedicationList, LibVars.medicationlistlib.medicationList[number])) {
          ...
          com.fc.JavaScriptDistLib.Image.setProperty["Image"]("Checkbox", (com.fc.JavaScriptDistLib.ImageLibrary.createImageFromResource("./img/empty.png"))); // Block#: gPyEu;9!Ro3gG1*P?SN_
          ...
          com.fc.JavaScriptDistLib.Image.setProperty["Image"]("Checkbox", (com.fc.JavaScriptDistLib.ImageLibrary.createImageFromResource("./img/checked.png"))); // Block#: hO9:!NJKw*a0Du%@4m.Z
    ...
    // Block#: BA{?*jPXh?IfW]:vJBQv
    function on_listview_cell_configure_height_MedicationCell(MedicationCell, number) {
      try {
        // Block#: bgB3|]4~g2/9]xq@6%:O
        LibVars.medicationlistlib.cellHeight = (com.fc.JavaScriptDistLib.Label.getTextHeight(com.fc.JavaScriptDistLib.TextLib.convertToText(LibVars.medicationlistlib.medicationList[number]), 270, 'Century Gothic', 14)) + 24;
        return LibVars.medicationlistlib.cellHeight
      } catch(e) {
        com.fc.JavaScriptDistLib.handleExceptionNative(e);
      }
    };
    com.fc.JavaScriptDistLib.ListView.setConfigHeightCallback('MedicationCell', on_listview_cell_configure_height_MedicationCell);
  ...
  function HealthDashboardLibrary() {
    lib_instance = "xd1ey37gib";
    com.fc.JavaScriptDistLib.EventListeners.mapLib("HealthDashboardLibrary", "xd1ey37gib");
    ...
    function StatisticsLibrary() {
      lib_instance = "qn8m8opuiu";
      com.fc.JavaScriptDistLib.EventListeners.mapLib("StatisticsLibrary", "qn8m8opuiu");
    ...
    function handleBackButton() {
      return new Promise(function(resolve, reject) {
        com.fc.JavaScriptDistLib.EventListeners.invoke("handleBackButton", "xd1ey37gib", []);
      });
    }
    /**
     * Describe this function...
    ...
    function authorizationStarted() {
      return new Promise(function(resolve, reject) {
        com.fc.JavaScriptDistLib.EventListeners.invoke("authorizationStarted", "xd1ey37gib", []);
      });
    }
    /**
     * Describe this function...
    ...
    function handleShareButton() {
      return new Promise(function(resolve, reject) {
        com.fc.JavaScriptDistLib.EventListeners.invoke("handleShareButton", "xd1ey37gib", []);
      });
    }
    /**
     * Describe this function...
  ...
  function HealthDataUploadLibrary() {
    lib_instance = "mk8aw3oim3";
    com.fc.JavaScriptDistLib.EventListeners.mapLib("HealthDataUploadLibrary", "mk8aw3oim3");
  ...
  function S25HideObjects() {
    return new Promise(function(resolve, reject) {
      ...
      $('[obj-name="B25Skip"]').hide(); // Block#: ,S5/DHQP*.5$#Xsj9G(m
  ...
  function S23HideObjects() {
    return new Promise(function(resolve, reject) {
      // Block#: QdXS11I]@45InH?kEy[J
      $('[obj-name="B23Back"]').hide(); // Block#: ~]LDBP1oE*truP+07U4l
      $('[obj-name="B23Cancel"]').hide(); // Block#: ?/^C:QsgmZ25ys/sm928
      $('[obj-name="B23Skip"]').hide(); // Block#: P$`6}EP+Wm,*wiIGoaB]
      $('[obj-name="B23Next"]').hide(); // Block#: Y(yS@9OZ2{%qn#0!CPBg
      $('[obj-name="L23Units"]').hide(); // Block#: e,::f[RWrQ84jG{oh/cT
      $('[obj-name="L23Title"]').hide(); // Block#: g6NE!J=bgv$8OWFf7dTG
      $('[obj-name="L23Error"]').hide(); // Block#: SX:O0.rl-Qf~5Hj2dfV^
      $('[obj-name="L23Question"]').hide(); // Block#: z4.,LHQYYOdMD=oa}Kv/
  ...
  function S25UpdateScreen() {
    return new Promise(function(resolve, reject) {
      ...
      // Block#: +XWar%[^/X^L-+wV@D85
      if(_that.currentProperty != null) {
        // Block#: mr`@Jv~-q.K?3tU%(QOk
      ...
      // Block#: !5j/pmI.w2;0s!o!6lzF
      _that.currentProperty = getOutcomeName('B25Cancel');
      // Block#: 9uKabq]{ht*HD8A`HM);
      if(_that.currentProperty != null) {
        // Block#: 4}Q;]zi8hJNN/Uys2gA`
        $('[obj-name="B25Cancel"]').show(); // Block#: l~[=n|=o-A2}%W-q^OAR
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B25Cancel", _that.currentProperty);
      }
      // Block#: T5OWg_pW$.y!au=Ns`[w
      _that.currentProperty = getOutcomeName('B25Next');
      // Block#: 35(F$c1ft(H?!Q+g(n^S
      if(_that.currentProperty != null) {
        // Block#: |p@b028980L+1tcKc?_d
        $('[obj-name="B25Next"]').show(); // Block#: flyib3A22G}:oFiAznkx
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B25Next", _that.currentProperty);
      }
      // Block#: :28o/[:J17X#,G4bKunW
      _that.currentProperty = getOutcomeName('B25Skip');
      // Block#: {qXV/0Rx(}0~4`bk!Nv7
      if(_that.currentProperty != null) {
        // Block#: }E8{uJ?pI_/u1-?VAHU5
        $('[obj-name="B25Skip"]').show(); // Block#: R;`,B^pmeFl:sTj%TYh6
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B25Skip", _that.currentProperty);
      }
      // Block#: P~o]wouNqftO@,:@VjgX
      _that.currentProperty = getFormProperty('title');
      // Block#: *pm+OSf.dG(1~gj#Fnx}
      if(_that.currentProperty != null) {
        // Block#: /+V;EK@a0y$l2d,1j`4Q
        $('[obj-name="L25Title"]').show(); // Block#: ix;gvDGu+5BSb|(rEf)!
  ...
  function S23UpdateScreen() {
    return new Promise(function(resolve, reject) {
      ...
      // Block#: /8g]=}Hq=$r%G#~)87]n
      _that.currentProperty = getOutcomeName('B23Back');
      // Block#: me5VR2iB|]|rwI@a}|w5
      if(_that.currentProperty != null) {
        // Block#: +:yOdoc/td)R]-+~eDCW
        $('[obj-name="B23Back"]').show();
      }
      // Block#: 2Z[k;@@pK]SR#7Q6}(m`
      _that.currentProperty = getOutcomeName('B23Cancel');
      // Block#: f#yk6Sg2NDQ?4jz2igue
      if(_that.currentProperty != null) {
        // Block#: :Umm?F{w^,[RXD`NQ%D[
        $('[obj-name="B23Cancel"]').show(); // Block#: `S8-p|XB%];OAq+O@l*X
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B23Cancel", _that.currentProperty);
      }
      // Block#: NLqyYE,+NdUFNrjog=F$
      _that.currentProperty = getOutcomeName('B23Next');
      // Block#: XI(4RE|jQY:9neNy%ab}
      if(_that.currentProperty != null) {
        // Block#: nxs|S4(YqA)9WtuS~RBc
        $('[obj-name="B23Next"]').show(); // Block#: }?}e)0(l$/jCBqA=gpJZ
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B23Next", _that.currentProperty);
      }
      // Block#: e+p6v-5{L/LYddR5_[5+
      _that.currentProperty = getOutcomeName('B23Skip');
      // Block#: j|8,{uggmKA82J|jKz:R
      if(_that.currentProperty != null) {
        // Block#: C~8OUd=QKZ7ECgs~8y`v
        $('[obj-name="B23Skip"]').show(); // Block#: Q)/m2ccLtW899@XpP*E$
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B23Skip", _that.currentProperty);
      }
      // Block#: q!$|eQJUDvan=_::D`;n
      _that.currentProperty = getFormProperty('title');
      // Block#: pp+6~WX|c1Tv*:yq,D;P
      if(_that.currentProperty != null) {
        // Block#: D?@0;,BY?j,05=`2}KXU
        $('[obj-name="L23Title"]').show(); // Block#: rG|P3d8lb6M~;]VYYNnQ
      ...
      // Block#: mu#/|s}Yz74j^e$J,.@A
      _that.currentProperty = getFormProperty('L23Units');
      // Block#: pm=VVJ3Vvx;$9A67~Pgm
      if(_that.currentProperty != null) {
        // Block#: _YnOLP,OOS[$}ip1xS_B
        $('[obj-name="L23Units"]').show(); // Block#: H,tNJ`v__VfaNo=*~d-/
        com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L23Units", _that.currentProperty);
      }
      // Block#: C4i7Nh`KS+6x^6IR/Q8?
      _that.inputType = getFormField('answer1', 'type');
      ...
      // Block#: 2dF%;u^9fRx`O]2)%*z3
      $('[obj-name="L23Question"]').show(); // Block#: BN5/?K|hOESIe0}W}+SR
  ...
  function s28HideObjects() {
    return new Promise(function(resolve, reject) {
      ...
      $('[obj-name="TA28Textarea"]').hide(); // Block#: e4;~:rraI}8yIXg[w@3-
      $('[obj-name="B28Back"]').hide(); // Block#: oiC6H:PE9~fDnx,Ib*,g
      $('[obj-name="B28Cancel"]').hide(); // Block#: `Xci*r9D{4vVp4yX@px!
      $('[obj-name="B28Next"]').hide(); // Block#: bo%)rus2}3*u:|T!juKv
      $('[obj-name="B28Skip"]').hide(); // Block#: ou^/ZG}|FuBIoaKb4^jb
      $('[obj-name="L28Question"]').hide(); // Block#: -b}0||Ur-_Fo(/4=O}%6
  ...
  function findActiveInstances() {
    return new Promise(function(resolve, reject) {
      ...
      // Block#: 1#,h]zm|v4ZW)JccJ?#N
      if(com.fc.JavaScriptDistLib.TextLib.textComparison('intake', "EQUAL", getFormPropertyValue('phase'))) {
        // Block#: j_vU.lo3I;{Bn?-W5k6O
        getActiveFlow('PowerMomIntakeSurvey').then(response => {;
          if(response.name === "data") {
            // Block#: 8SWP~4My+rCDEPkuK#_c
            console.log('activeWeeklyForm');
            if(_that.debugService && _that.debugService.active) {
              _that.debugService.traces.push('activeWeeklyForm');
              _that.debugService.printLog();
            }
            // Block#: [Go[`6Qw/=4ZiV)v_xQF
            console.log(response.data);
            if(_that.debugService && _that.debugService.active) {
              _that.debugService.traces.push(response.data);
              _that.debugService.printLog();
            ...
            // Block#: DSb||eHm~yK@F]*Dtv/w
            getActiveFlow('PowerMomHealthHistorySurvey').then(response => {;
              if(response.name === "data") {
                // Block#: )Vx9PL4ms0$jXagL}k)C
                console.log('activeWeeklyForm');
                if(_that.debugService && _that.debugService.active) {
                  _that.debugService.traces.push('activeWeeklyForm');
                  _that.debugService.printLog();
                }
                // Block#: Ni%bL0CExQ,TTcfWz8zQ
                console.log(response.data);
                if(_that.debugService && _that.debugService.active) {
                  _that.debugService.traces.push(response.data);
                  _that.debugService.printLog();
        ...
        // Block#: hQxEBVcUEm;of(@1t:{M
        getActiveFlow('PowerMomWeeklySurvey').then(response => {;
          if(response.name === "data") {
            // Block#: BmuNQRbum/D[u}LdNfY4
            console.log('activeWeeklyForm');
            if(_that.debugService && _that.debugService.active) {
              _that.debugService.traces.push('activeWeeklyForm');
              _that.debugService.printLog();
            }
            // Block#: Y_jVaBw.S$)}MNYF~Hiu
            console.log(response.data);
            if(_that.debugService && _that.debugService.active) {
              _that.debugService.traces.push(response.data);
              _that.debugService.printLog();
        ...
        // Block#: {[!s|I9i(f]/S6*t9QCm
        getActiveFlow('PowerMomOutcomeSurvey').then(response => {;
          if(response.name === "data") {
            // Block#: YG~ZBj|`]G]PY,dW65Nr
            console.log('activeWeeklyForm');
            if(_that.debugService && _that.debugService.active) {
              _that.debugService.traces.push('activeWeeklyForm');
              _that.debugService.printLog();
            }
            // Block#: #7xktHpC$Q4`a#]8T]8.
            console.log(response.data);
            if(_that.debugService && _that.debugService.active) {
              _that.debugService.traces.push(response.data);
              _that.debugService.printLog();
  ...
  function S22HideObjects() {
    return new Promise(function(resolve, reject) {
      // Block#: +5EM6Wut_vYC:-fQ)y)I
      $('[obj-name="B22Next"]').hide(); // Block#: +T+9[ZjtDYzTi?QX*9!J
      $('[obj-name="B22Back"]').hide(); // Block#: SyU@U}!HLMfqgM!j7az]
      $('[obj-name="B22Cancel"]').hide(); // Block#: iw}(.nK.%*Rz*sG^FE^b
      $('[obj-name="B22Skip"]').hide(); // Block#: mq_oHP+Kqc[B3JRps8Q|
      $('[obj-name="L22Question"]').hide(); // Block#: r9Vaob=QB!1YyAWRGyZy
      $('[obj-name="L22Error"]').hide(); // Block#: DT$16vOK]WWi$jIjPBw_
  ...
  function s28UpdateScreen() {
    return new Promise(function(resolve, reject) {
      ...
      // Block#: 2}zyAO3Pxjr4B?2=xXV}
      _that.currentProperty = getOutcomeName('B28Back');
      // Block#: h|g:gd%]KKE?vX#t5K:I
      if(_that.currentProperty != null) {
        // Block#: ySW_AVq)`4w9A=t#NupV
        $('[obj-name="B28Back"]').show();
      }
      // Block#: j_f7bXYn!WE(]wX^mket
      _that.currentProperty = getOutcomeName('B28Cancel');
      // Block#: L#5Gjd(XU:HQD=XrCK`s
      if(_that.currentProperty != null) {
        // Block#: 0,xI_Gac,m.SVo]U:qeq
        $('[obj-name="B28Cancel"]').show(); // Block#: Tk6xz9eV{xeB6hgfS]E[
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B28Cancel", _that.currentProperty);
      }
      // Block#: Hhj?ACq`cj:tr,v5UmOC
      _that.currentProperty = getOutcomeName('B28Next');
      // Block#: H+jFE.a.u*M.(~Bo-2=K
      if(_that.currentProperty != null) {
        // Block#: 9yVw{AvyLa$jZnE}Ftk~
        $('[obj-name="B28Next"]').show(); // Block#: kr)M0[shkbh*c?s6Ijf(
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B28Next", _that.currentProperty);
      }
      // Block#: I`_;*t5,Z9D3Z==`jp1q
      _that.currentProperty = getOutcomeName('B28Skip');
      // Block#: aRulTf8=:Is$:{s#sz.8
      if(_that.currentProperty != null) {
        // Block#: ^Mg8hkPS]:?;3L!?QiO}
        $('[obj-name="B28Skip"]').show(); // Block#: R|X34nBW?}NYpdEABg8X
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B28Skip", _that.currentProperty);
      }
      // Block#: jg,:bjwWJ)Ka32o|Xs_]
      _that.currentProperty = getFormProperty('title');
      // Block#: Sg{Ci(:,}yYRc(v+0h,e
      if(_that.currentProperty != null) {
        // Block#: Vs9_:MX!YobAkN!!3FK$
        $('[obj-name="L28Title"]').show(); // Block#: 83Hvijy/P/N$rf_GhDb#
        com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L28Title", _that.currentProperty);
      }
      // Block#: !]2h;IuHTEJP9Dh]bCmG
      _that.inputType = getFormField('answer1', 'type');
      // Block#: WH*m-*e,gaAK?~j+=]rj
      if(_that.inputType != null) {
        // Block#: G~*y9lhA^DI|Y}=ru;A_
        if(com.fc.JavaScriptDistLib.TextLib.textComparison(_that.inputType, "EQUAL", 'boolean')) {
          // Block#: m^/3x5-bDv#dGwc;LD!X
          _that.currentProperty = getFormProperty('question');
          // Block#: 7Ei25iJTO|7a)vpUv,,*
          if(_that.currentProperty != null) {
            // Block#: a%x*7JL}lAV5z*o}18h%
            $('[obj-name="L28Question"]').show(); // Block#: T67iRRqum^MJ{0POWJ@g
            com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L28Question", _that.currentProperty);
          }
        } else {
          // Block#: b1pR`yR`KH77g_V$1C0E
          $('[obj-name="L28Question"]').show(); // Block#: 6gS@Lu?j/eG*Bt{trN5S
          com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L28Question", (getFormField('answer1', 'name'))); // Block#: N!w6Vn.c)wd3Ty`:fL%h
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(_that.inputType, "EQUAL", 'text') ||
            com.fc.JavaScriptDistLib.TextLib.textComparison(_that.inputType, "EQUAL", 'password')
          ) {
      ...
      // Block#: XLn@OQ-lrC-wwc-0LdO0
      if(com.fc.JavaScriptDistLib.TextLib.textComparison(_that.inputType, "EQUAL", 'text') ||
        com.fc.JavaScriptDistLib.TextLib.textComparison(_that.inputType, "EQUAL", 'integer')
      ) {
        // Block#: j7}q~0OdXF8;wZ~a70:_
        _that.currentProperty = getFormField('answer1', 'value');
        // Block#: l8qw;db0%Kd*(Fm(,rIE
        if(!(_that.currentProperty == null)) {
          // Block#: @c+MdOO*$tdkGkyIwx~s
          $('[obj-name="TA28Textarea"]').show(); // Block#: uxJ(zQH)eWTpW@-yayaW
          com.fc.JavaScriptDistLib.Textarea.setProperty["Text"]("TA28Textarea", _that.currentProperty); // Block#: mIMhGh;uod/?.]-Cj./2
          _that.selectionMade = true;
        }
      }
  ...
  function S22UpdateScreen() {
    return new Promise(function(resolve, reject) {
      // Block#: ;U4K4sk2SgKd`6d)`:lo
      S22HideObjects().then(response => {;
      });
      // Block#: -3@6WsqZimQHlx$Wr-A8
      _that.currentProperty = getOutcomeName('B22Back');
      // Block#: {6(AnZ45(VyDqkDb_rBx
      if(_that.currentProperty != null) {
        // Block#: a?u(YFsw4]3P`Z4IW-rK
        $('[obj-name="B22Back"]').show();
      }
      // Block#: !Q9jC,,jJD*~Gz2Azp+o
      _that.currentProperty = getOutcomeName('B22Cancel');
      // Block#: ;Z2Y=]$#?qMKNySFs3j[
      if(_that.currentProperty != null) {
        // Block#: -OOA07j^=`h-k2t0pJIn
        $('[obj-name="B22Cancel"]').show(); // Block#: `^09vX/%aD`*w9[fea_Q
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B22Cancel", _that.currentProperty);
      }
      // Block#: z$YjfXR4=h;WhKTA8-=B
      _that.currentProperty = getOutcomeName('B22Next');
      // Block#: 2T(yLEC09V~NKVSfc2BW
      if(_that.currentProperty != null) {
        // Block#: 8RVXLdk(xU6UwY`Jhvhl
        $('[obj-name="B22Next"]').show(); // Block#: RIsH=?++(WnK?n}UY{Xv
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B22Next", _that.currentProperty);
      }
      // Block#: ]_ad$BL7*;p(6xvCIvn7
      _that.currentProperty = getOutcomeName('B22Skip');
      // Block#: 3Zwdo@f,F!zGh|.n4yZs
      if(_that.currentProperty != null) {
        // Block#: /sM1E6C4_TITAgoFSz1f
        $('[obj-name="B22Skip"]').show(); // Block#: +P=,Q3q{7XanOfX.$@hF
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B22Skip", _that.currentProperty);
      }
      // Block#: 153M!Rs-vVhI_/I8BAu0
      _that.currentProperty = getFormProperty('title');
      ...
      // Block#: y(^y@Souq?lX6m;2-70=
      $('[obj-name="L22Question"]').show(); // Block#: KAS1Dew8owoEZd|=1HY,
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L22Question", (getFormField('answer1', 'name'))); // Block#: Eqo.GzY#/eRUd:KC!:=U
      _that.inputType = getFormField('answer1', 'type');
  ...
  function B25NextUpdate() {
    return new Promise(function(resolve, reject) {
      // Block#: ZXA(}u8GoJUceRNimAd~
      if(_that.selectionMade) {
        // Block#: bAC$nLThKd9CQkc@=|jJ
  ...
  function b28NextUpdate() {
    return new Promise(function(resolve, reject) {
      // Block#: IZJfUq!{|e9$P#i5KRA]
      if(_that.selectionMade) {
        // Block#: kO7EGWbTa.G#I*;boItI
        com.fc.JavaScriptDistLib.Button.setProperty["Background color"]("B28Next", (com.fc.JavaScriptDistLib.ColourLibrary.getColourFromText('#dd198e'))); // Block#: %4/*x(6JioZ5X/jVPY{d
        ...
        // Block#: aU.?/qvpd;s$du/OX9Kp
        com.fc.JavaScriptDistLib.Button.setProperty["Background color"]("B28Next", (com.fc.JavaScriptDistLib.ColourLibrary.getColourFromText('#f4badd'))); // Block#: s/tJLU2(@b)AQ7:l4Ab5
  ...
  function B23NextUpdate() {
    return new Promise(function(resolve, reject) {
      // Block#: JLYo?A7Ih_~xm90~+cyF
      if(_that.selectionMade) {
        // Block#: @-71(eZTsbQGo:c/hmmn
  ...
  // Block#: SX*lXHKYv9+(C#y1?~xG
  function on_screen_showS25AddMedication() {
    try {
      // Block#: LT4sLZ|j6Zq9#5DJ#Z=O
      ...
      if(_that.S25FirstDisplay) {
        ...
        com.fc.JavaScriptDistLib.Button.setProperty["Text"]("B25Add", 'Add Medication'); // Block#: taPSMclH]l?3H%lLdC%$
        _that.selectionMade = false;
  ...
  // Block#: h(Fr!.K]7?__D8Sl?(F!
  function on_screen_showS23SingleInput() {
    try {
      // Block#: f/-(nskZ6ON1X?EAz{Xx
      _that.currentScreen = 'S23SingleInput';
      // Block#: A@:ULC3mp=xRW9)Z/Fw=
      com.fc.JavaScriptDistLib.Textbox.setProperty["Text"]("T23Text", ''); // Block#: yII,lXC7#|x~KMSYa~J)
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L23Error", 'Invalid input'); // Block#: ^Y,$R5sh;~S0l=wir:?$
      _that.selectionMade = false;
  ...
  // Block#: QCgv,FQ=JUcgpxLdUmI;
  function on_screen_showS24Medication() {
    try {
      // Block#: :sn-=8A@PB2$|adfP~uZ
  ...
  // Block#: |AvhhUNc,zG;J`a*IB9t
  function on_B23Skip_click(e) {
    try {
      // Block#: fgBabR49CRsS2IwV:A3~
      if(!_that.buttonClicked) {
        // Block#: kKnY8F;Me8IBM}$p`jWp
        if(getOutcomeName('B23Skip') != null) {
          // Block#: Ys*I_yw_pg;{P1V#6ROV
          _that.buttonClicked = true;
          // Block#: xdil=@Gu#f}Z}9dH3B#$
  ...
  // Block#: :l}ObxGmjI:=L6,~e-X6
  function on_B25Add_click(e) {
    try {
      // Block#: on8z6xB5oR|pu6?(6N:E
      if(!_that.buttonClicked) {
        ...
        if(getOutcomeName('B25Add') != null) {
          ...
          // Block#: hL@#DQa.fQHkz_e9Db0v
          _that.buttonClicked = true;
          // Block#: G/7I1b:$El5I^c(V;/QX
          com.fc.JavaScriptDistLib.Screen.setProperty["Loader Visible"]("S25AddMedication", true); // Block#: lcDdM!LkcsV0lM|~Xb?w
    ...
    try {
      ...
      if(!_that.buttonClicked) {
        ...
        if(com.fc.JavaScriptDistLib.TextLib.textComparison(com.fc.JavaScriptDistLib.Button.getProperty["Text"]("B3Cancel"), "EQUAL", 'Cancel')) {
          // Block#: `f)vt-P2^az=,KT9T6JJ
          _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
          // Block#: d4rO:MqL:cj$Y|Y=olKT
          com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
          // Block#: 6x8Ae:Oj3,qhzw3V8w81
          com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
          // Block#: $Sl]NcD1tPfzQNO#nEs^
          com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
            // Block#: L@mApa.38BsCuL!#u?yJ
            if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
              // Block#: wGvQ-%`#C8n/f07$AX#$
              _that.buttonClicked = true;
              // Block#: xFKve)q%.kl@2Q8b.^qo
  ...
  function on_B21Cancel_click(e) {
    try {
      // Block#: wsGhUm=hDkDc:O(`]8u4
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: )4U:cL6B-(ncpc6UyCXL
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: mD`yVdD15JhL4K4^EIzL
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: %`4Gre|@:,m3F|1`j1mS
      if(!_that.buttonClicked) {
        // Block#: |{4Y`-?B1@u?W}YsodxR
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: S_4IBwI,C)7{B^TgVK-=
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: /GU,Dv8Cv$}*xYuzsV7O
            _that.buttonClicked = true;
            // Block#: :)nNj3{,5rF,syMXhH2W
            com.fc.JavaScriptDistLib.Screen.setProperty["Loader Visible"]("S21Pin", true); // Block#: vv1A!kvZePAjy`TPXU2w
  ...
  // Block#: .K$1k$(_gv_g2[4^8nA}
  function on_B24Done_click(e) {
    try {
      // Block#: Poao7VHdg/1LfXu,z)ev
      if(!_that.buttonClicked) {
        // Block#: )cB5JS,L98uSpmi3PXC6
        if(getOutcomeName('B24Done') != null) {
          // Block#: q^pq*QFinV8}Fq1-9wrk
          _that.buttonClicked = true;
          // Block#: o5E1U6l#_U0S+5Dpno[S
          com.fc.JavaScriptDistLib.Screen.setProperty["Loader Visible"]("S24Medication", true); // Block#: Zat/2F/b|URi5r|+IX-p
  ...
  // Block#: }XQ_5lJ]u0FBB(*A+,xn
  function on_B23Back_click(e) {
    try {
      // Block#: XiOfWc/h,4!6PV:25vIn
      if(!_that.buttonClicked) {
        // Block#: }(_*H!4zu$@=F=MJHbg_
        if(getOutcomeName('B23Back') != null) {
          // Block#: HOEGH.0LiiL^`]+}{M8Y
          _that.buttonClicked = true;
          // Block#: =QgS~i:]^zwk%CTp#{1#
          _that.returnError = saveTaskAndNext(getOutcomeName('B23Back'));
        }
      }
      e.stopPropagation();
  ...
  // Block#: kuwGD=U6;hV;Elzh*(/p
  function on_screen_showS28TextAreaInput() {
    try {
      // Block#: 4qj{]hscUdCzf5pJ@*u~
  ...
  // Block#: ^b,Biz2^68R3czbfE,!g
  function on_screen_showS22DualInput() {
    try {
      // Block#: g,IBnwA}-]6.P!^hnKD8
      ...
      com.fc.JavaScriptDistLib.Label.setProperty["Text"]("L22Error", 'Invalid input'); // Block#: ,e21~%OFZ$Q?H5T2-57m
      _that.selectionMade = false;
  ...
  // Block#: )nR[TYyX]C!ZYu8z{@5Z
  function on_B25Back_click(e) {
    try {
      // Block#: E$eIFE-cK,0|~L|;hMY=
      if(!_that.buttonClicked) {
        // Block#: 1uprC(SBfW$`Y.ACJrT#
        if(getOutcomeName('B25Back') != null) {
          // Block#: [d[_[G=c(Nt%tXNitZGy
          _that.buttonClicked = true;
          // Block#: :22*c)^hOMX_wGR`~nfT
          com.fc.JavaScriptDistLib.Screen.setProperty["Loader Visible"]("S25AddMedication", true); // Block#: oQ2-0?x/F16+p=8,2B/x
          _that.returnError = saveTaskAndNext(getOutcomeName('B25Back'));
        }
      }
      e.stopPropagation();
  ...
  // Block#: 00D.b-J*MC95!)n)S8+!
  function on_B22Skip_click(e) {
    try {
      // Block#: *0$.@1?]5gF~p|q}[9O1
      if(!_that.buttonClicked) {
        // Block#: c1yKcv9K]yk1JQ#^f2pK
        if(getOutcomeName('B22Skip') != null) {
          // Block#: o0c9c/|%#s*9:6S[z1!a
          _that.buttonClicked = true;
          // Block#: Hw3NyBY0Mpu3HN{q3eT5
      ...
      if(!_that.buttonClicked && _that.selectionMade) {
        ...
        if(getOutcomeName('B22Next') != null) {
          ...
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(_that.inputType, "EQUAL", 'text')) {
            ...
            // Block#: LysKN[FaH@Y.iSojLl5S
            _that.buttonClicked = true;
            // Block#: mMV|Pa=,I@DJ)4)mY,uZ
  ...
  // Block#: Q0v:xGlg]v4q]$-32!/e
  function on_B23Cancel_click(e) {
    try {
      // Block#: u?/8z8pj:9s)3FO^7W6b
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: 94~:Q[im/^TEuxmqP)~3
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: xcQ,!Oh.R|CszHW;_8bt
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: 4gv*lDQZispvy+_vbpm9
      if(!_that.buttonClicked) {
        // Block#: ]Kiv9gv^nC#3=Yt4MG!:
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: {LaduZZxi|ZiV#IaZ6I^
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: +x)6pphM]vZn,6`K3XI=
            _that.buttonClicked = true;
            // Block#: w.Scv4)--YrN=3E)})FZ
  ...
  function on_B11Cancel_click(e) {
    try {
      // Block#: 1~p_SqKuNwk@rjI,6^EX
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: TC0;JRBvptwna^FX59*t
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: (z#Bb|}OPoxmb+hZMG%*
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: Q?|TJwoZbh!YvuFNZmhO
      if(!_that.buttonClicked) {
        // Block#: i|x*HI0aa!WzVQ-{p`LZ
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: Lv/;!?T.b|0YYpmQ?nPW
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: Gx7/h9`m?%z-x8:7BK*v
            _that.buttonClicked = true;
            // Block#: zglDkyYXg`f7fXM2gFOo
  ...
  // Block#: Vd^%7sH}kc_ieCW[Mb=9
  function on_B22Back_click(e) {
    try {
      // Block#: 8olSDDvSfTZmDI=-FdVE
      if(!_that.buttonClicked) {
        // Block#: |?38=ch@fMD:h~jNc!5J
        if(getOutcomeName('B22Back') != null) {
          // Block#: #rG+$0ypCjW{EtThH{?d
          _that.buttonClicked = true;
          // Block#: U(]/VQj!3{1vN-l~D+y:
          _that.returnError = saveTaskAndNext(getOutcomeName('B22Back'));
        }
      }
      e.stopPropagation();
  ...
  function on_B9Cancel_click(e) {
    try {
      ...
      if(!_that.buttonClicked) {
        // Block#: {.VoQS#35l-+0xRXjqD9
        _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
        // Block#: :EdKLA-1[Ut*`-8_36A2
        com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
        // Block#: 9irl6P1h4el5}-@rg*r:
        com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
        // Block#: ua^08S%L$A$]*%qVss/}
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: $?!/jS~izg?/YQ,bjL?v
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: g+zpBlrIg2CTcN)U;I-O
            _that.buttonClicked = true;
            // Block#: @]#{^~H=G%i@R=dRPP~j
    ...
    try {
      ...
      if(!_that.buttonClicked) {
        ...
        if(com.fc.JavaScriptDistLib.TextLib.textComparison(com.fc.JavaScriptDistLib.Button.getProperty["Text"]("B4Cancel"), "EQUAL", 'Cancel')) {
          // Block#: jpFHu:n6eZ3}Y$l-Iv~~
          _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
          // Block#: n@bkG*}Lnu@2xZ7[@|5K
          com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
          // Block#: S7.?gdXwhgwdfe?dz%/U
          com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
          // Block#: Rmpj@^QrSiivuz_TLHaJ
          com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
            // Block#: (K|/.`ixn+f+`O|:jly#
            if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
              // Block#: ni:?/oakRxy!H/hgz@Oe
              _that.buttonClicked = true;
              // Block#: pfL$z(hui|AK#D7mH$X+
  ...
  function on_B28Skip_click(e) {
    try {
      // Block#: i-DMoACN!fTpG;Zp`1Pd
      if(!_that.buttonClicked) {
        // Block#: T=,ZE+G1,ppL,bUwsV9A
        if(getOutcomeName('B28Skip') != null) {
          // Block#: (-9kUq=Q`1cVXYn2:}b7
          _that.buttonClicked = true;
          // Block#: ]h6)g*0:#=2Inb;FkOQx
  ...
  function on_B12Cancel_click(e) {
    try {
      ...
      if(!_that.buttonClicked) {
        ...
        if(!_that.isLoggingIn) {
          // Block#: ls]g/u0DR@$FXb.Y29c=
          _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
          // Block#: ^-:cc_yp|r|Z{3Fe:odi
          com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
          // Block#: ?=!;:z~rq7h*!iA!Zo!`
          com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
          // Block#: 5BC]r?1h#!qPk%V}Uc2r
          com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
            // Block#: tMV_aE]knLsRFO_DoY)a
            if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
              // Block#: gj@9VUw{@7;V|k.x%(Tv
              _that.buttonClicked = true;
              // Block#: o+58L?mFdh}ju*a*PHlf
              com.fc.JavaScriptDistLib.Screen.setProperty["Loader Visible"]("S12Email", true); // Block#: 6gMd1U|hgTta2jZ@@3HX
  ...
  // Block#: YRNI!MEvER(iq@j?^my.
  function on_B22Cancel_click(e) {
    try {
      // Block#: LPjLZR~t4.u-}W7TTAo+
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: EuN40s:zI:w0AQTh.`9^
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: kv7fn@Z49@X+(BRnD#Ll
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: d9rzCZamz!c}ydq7R#:X
      if(!_that.buttonClicked) {
        // Block#: A-Yd4y!I!Of)dWmwjvPW
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: _OLRcqA:_vE/AqacGv03
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: RfrxUqVkN:Cek2iv[be9
            _that.buttonClicked = true;
            // Block#: P2Yd8[n4bk!NWO^w[ggo
  ...
  // Block#: [z%K/aQDJlWE*o7wk_g7
  var elemSelector = '[obj-name="T23Text"]';
  $(elemSelector).find(".textView").on('input', function(e) {
    var oldText = $(this).attr("previousValue");
    var newText = $(this).val();
    $(this).attr("previousValue", newText);
    // Block#: ObGbe!:BgwajYXiKGX}a
    _that.selectionMade = false;
  ...
  // Block#: ]P|N(N@sI*:h()lRPA!:
  function on_B25Cancel_click(e) {
    try {
      // Block#: ;I1}7-fH{9DnW1XN4]7h
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: WXIlwvgRp!9$9EQcCj?{
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: oNX%HWn9Ok-G%C0+nepE
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: jp5%;R/*.Lm0?wk}zh#6
      if(!_that.buttonClicked) {
        // Block#: ``o!=1Qi[#(86|g$2%X-
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: c-0C!}YJ|SO/airBT=2|
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: cs~]f/(*f4hhK7DPGVL+
            _that.buttonClicked = true;
            // Block#: ,TSsgfK*/Dc1~AWg1VD#
            com.fc.JavaScriptDistLib.Screen.setProperty["Loader Visible"]("S25AddMedication", true); // Block#: PD|bg?l.8DWFA/uT^-?D
  ...
  function on_B8Cancel_click(e) {
    try {
      ...
      if(!_that.buttonClicked) {
        // Block#: [:Ux+.PzSY)HL4t}/lu)
        _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
        // Block#: _FO7{,2[8]}IaW[/Xh#R
        com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
        // Block#: HbFHmHQOq@Zq:g$rtW5y
        com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
        // Block#: *xd*+`Ra)!4d0N-r@J.~
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: C@MbIj90}H0ufO6V9#}Y
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: K%;=Jh9#f||:xDdU)#Zy
            _that.buttonClicked = true;
            // Block#: dXh{Hgac%SWz#(S!X:6`
  ...
  function on_B26Cancel_click(e) {
    try {
      // Block#: DXxMKXzGevu:qd6?/K,k
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: ]SK!F7uXKVY1c)^Jwc~v
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: *6QGo/W8/)4.S=)jJ$T4
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: ;]O2HL|iaX2di$t$ecyF
      if(!_that.buttonClicked) {
        // Block#: /UL1RQ*5.elCi#=eHuM|
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: 4OgIf`TSXEsIKP8g0bfd
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
  ...
  function on_B28Cancel_click(e) {
    try {
      // Block#: LVj$-LN11sWcJ;o=A|Pm
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: 52OKm+TP8wT9o`sm$)?m
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: _x.|7`*ruqOjU+b}`Zo}
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: q{Caj_Ci6)6:45|p0,ee
      if(!_that.buttonClicked) {
        // Block#: t;Lv+wh-|+B%jqpZgioM
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: #z$7-q)xkWEG/a_77;AJ
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: )8k}y?/$`NLNP3GjwPY_
            _that.buttonClicked = true;
            // Block#: AH3(Z{Q^{;pq}~~vPeV;
  ...
  function on_B20Cancel_click(e) {
    try {
      // Block#: ?+2yNhk)?$d%|}zp]Ajp
      _that.dialog = (com.fc.JavaScriptDistLib.Dialog.create(_that.genericDialogTitle, _that.genericDialogBody));
      // Block#: )TsEs~K*lQZH{u{W:@N:
      com.fc.JavaScriptDistLib.Dialog.addCancelBtn('No', _that.dialog)
      // Block#: zw;!b0bIY7j4%~cZX=$[
      com.fc.JavaScriptDistLib.Dialog.addBtn('Yes', _that.dialog)
      // Block#: ?!lOx1yd|x+^V]ruy58m
      if(!_that.buttonClicked) {
        // Block#: FnmY1x95$=#o9/p2~X0^
        com.fc.JavaScriptDistLib.Dialog.show(_that.dialog, function(button_title) {
          // Block#: r7pvG5N^PBo6[(X26N;G
          if(com.fc.JavaScriptDistLib.TextLib.textComparison(button_title, "EQUAL", 'Yes')) {
            // Block#: 3B40L?;)-syhgx68xEhf
            _that.buttonClicked = true;
            // Block#: qtG^q5Tk8AM.DV0LT#i7
